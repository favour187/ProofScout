const CACHE='proofscout-v5';
const ASSETS=['./','./index.html','./proofscout-offline.html','./extension/proofscout-extension.zip','./styles.css','./app.js','./manifest.webmanifest','./icon.svg'];
