const CACHE='proofscout-v7';
const ASSETS=['./','./index.html','./privacy.html','./proofscout-offline.html','./extension/proofscout-extension.zip','./styles.css','./app.js','./manifest.webmanifest','./icon.svg'];
