const CACHE='proofscout-v14';
const ASSETS=['./','./index.html','./privacy.html','./proofscout-offline.html','./demo-target.html','./styles.css','./app.js','./scout.js','./scout.css','./manifest.webmanifest','./icon.svg'];
