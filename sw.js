const CACHE='proofscout-v11';
const ASSETS=['./','./index.html','./privacy.html','./proofscout-offline.html','./9fb600ccaa8b44e2babe-1.0.1.xpi','./extension/proofscout-extension.zip','./styles.css','./app.js','./manifest.webmanifest','./icon.svg'];
